...
ax1 = [G * M * x1[i] / (x1[i] ** 2 + y1[i] ** 2) ** 1.5 + G * m2 * (x1[i] - x2[i]) / (
        (x1[i] - x2[i]) ** 2 + (y1[i] - y2[i]) ** 2) ** 1.5]
ay1 = [G * M * y1[i] / (x1[i] ** 2 + y1[i] ** 2) ** 1.5 + G * m2 * (y1[i] - y2[i]) / (
        (x1[i] - x2[i]) ** 2 + (y1[i] - y2[i]) ** 2) ** 1.5]
ax2 = [G * M * x2[i] / (x2[i] ** 2 + y2[i] ** 2) ** 1.5 + G * m1 * (x2[i] - x1[i]) / (
        (x2[i] - x1[i]) ** 2 + (y2[i] - y1[i]) ** 2) ** 1.5]
ay2 = [G * M * y2[i] / (x2[i] ** 2 + y2[i] ** 2) ** 1.5 + G * m1 * (y2[i] - y1[i]) / (
        (x2[i] - x1[i]) ** 2 + (y2[i] - y1[i]) ** 2) ** 1.5]
...
pygame.display.set_caption('Sun + 2 Planets by Louis')
...
for i in range(0, len(t) - 1):
    ...
    ax1.append(G * M * x1[i + 1] / (x1[i + 1] ** 2 + y1[i + 1] ** 2) ** 1.5 + G * m2 * (x1[i + 1] - x2[i + 1]) / (
            (x1[i + 1] - x2[i + 1]) ** 2 + (y1[i + 1] - y2[i + 1]) ** 2) ** 1.5)
    ay1.append(G * M * y1[i + 1] / (x1[i + 1] ** 2 + y1[i + 1] ** 2) ** 1.5 + G * m2 * (y1[i + 1] - y2[i + 1]) / (
            (x1[i + 1] - x2[i + 1]) ** 2 + (y1[i + 1] - y2[i + 1]) ** 2) ** 1.5)
    ax2.append(G * M * x2[i + 1] / (x2[i + 1] ** 2 + y2[i + 1] ** 2) ** 1.5 + G * m1 * (x2[i + 1] - x1[i + 1]) / (
            (x2[i + 1] - x1[i + 1]) ** 2 + (y2[i + 1] - y1[i + 1]) ** 2) ** 1.5)
    ay2.append(G * M * y2[i + 1] / (x2[i + 1] ** 2 + y2[i + 1] ** 2) ** 1.5 + G * m1 * (y2[i + 1] - y1[i + 1]) / (
            (x2[i + 1] - x1[i + 1]) ** 2 + (y2[i + 1] - y1[i + 1]) ** 2) ** 1.5)
    ...
    if e[i] > 10.0:  # collide
        collide = i
    if collide > 0:
        label3 = myfont.render("Colisão!", 1, red, white)
